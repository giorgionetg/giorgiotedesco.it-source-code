            ...
            <GridItem>
              <div className={classes.brand}>
                ...
                <h3 className={classes.subtitle}>
                  You can choose to login and save data on BlockStack (Gaia) or in your browser (LocalStorage).
                </h3>
              </div>
            </GridItem>
          </GridContainer>
        ...
        <div className={classes.container}>
          <GridContainer className={classes.gridStyle}>
            {postListCryptocurrencies.map((item) => {
              let linking = '/web-apps/' + item.slug;
                ...
                <GridItem sm={12} md={4}>
                  <Card style={{width: "20rem", marginLeft: "auto", marginRight: "auto"}}>
                    ...
                    <CardBody >
                      ...
                      <Button as='link' href={linking} fullWidth={true}>Go To</Button>
                    </CardBody>
                  </Card>
                </GridItem>
              )
